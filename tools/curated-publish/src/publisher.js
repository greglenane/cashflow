...
const ALLOWED_KEY_PATTERN =
  /^(accounts\/accounts\.parquet|transactions\/year=\d{4}\/transactions\.parquet|metrics\/(monthly_(cashflow|spending_by_category)|cashflow_periods|mtd_comparison)\.parquet|analytics\/(recurring|outlier)_purchases\.parquet|quality\/(account_status|account_reconciliation|data_status)\.parquet)$/;
